...
enum WorldBoolConfigs
{
    ...
    CONFIG_DUNGEON_ACCESS_LEVEL_REQUIREMENTS_OVERIDE,
    CONFIG_DUNGEON_ACCESS_GEARSCORE_REQUIREMENTS_OVERIDE,
    CONFIG_DUNGEON_ACCESS_QUESTS_REQUIREMENTS_OVERIDE,
    CONFIG_DUNGEON_ACCESS_ITEMS_REQUIREMENTS_OVERIDE,
    CONFIG_DUNGEON_ACCESS_ACHIEVEMENT_REQUIREMENTS_OVERIDE,
